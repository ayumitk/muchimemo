...
const BlockquiteContainer = styled.blockquote`
  ...
  background: rgba(0, 0, 0, 0.05);
    ...
    &:before {
      background: url('https://cdn.blog.st-hatena.com/css/theme/evergreen/images/quote.png?version=97326deÃ¢â‚¬Â¦&env=production') no-repeat;
  ...
  return (
    <>
      <BlockquiteContainer book={book}>
        {children}
        <Source>Source : <a href={srcURL}>{srcName}</a></Source>
      </BlockquiteContainer>
    </>
  )
}
