...
const MarshmallowContainer = styled.div`
  ...
  a{
    ...
    img{
      animation:fuwafuwa 0.4s infinite ease-out alternate;
    }
    @keyframes fuwafuwa {
...
const Marshmallow = () => {
  ...
  return (
    <MarshmallowContainer>
      <a href="https://marshmallow-qa.com/gina_muchimemon" target="_blank" target="_blank" rel="noopener noreferrer">
        <Image
          fixed={data.marshmallow.childImageSharp.fixed}
          alt='ジーナにマシュマロを投げる'
        />
        <h2>ジーナにマシュマロを投げる</h2>
